 ...
 */
function camisa10_disable_elementor_lazyload() {
    ?>
    <style>
        .e-con.e-parent {
    ...
    <script>
        // Prevenir erro de lazyloadRunObserver
        if (typeof lazyloadRunObserver !== 'undefined') {
            console.log('✅ lazyloadRunObserver desativado');
        }
    </script>
    <?php
}
add_action('wp_head', 'camisa10_disable_elementor_lazyload', 999);