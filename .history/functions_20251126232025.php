...
/**
 * Enfileira assets do Hero Banner
 */
function camisa10_hero_banner_assets() {
    if (!is_page_template('page-home.php') && !is_front_page()) {
        return;
    }
    ...
    wp_enqueue_style(
        ...
        array('camisa10-variables'), // Depende das variáveis
    ...
    wp_enqueue_script(
        ...
        array('jquery', 'bootstrap'), // Depende de jQuery e Bootstrap
        filemtime(get_stylesheet_directory() . '/assets/js/hero-banner.js'),
        true // Carregar no footer
    );
}
add_action('wp_enqueue_scripts', 'camisa10_hero_banner_assets', 25);
