        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-bottom-content">
                    ...
                    <!-- Social Links (via ACF Options) -->
                    <?php 
                    $facebook = camisa10_sanitize_url('social_facebook', 'option');
                    $instagram = camisa10_sanitize_url('social_instagram', 'option');
                    $linkedin = camisa10_sanitize_url('social_linkedin', 'option');
                    $youtube = camisa10_sanitize_url('social_youtube', 'option');
                    
                    if (!empty($facebook) || !empty($instagram) || !empty($linkedin) || !empty($youtube)) :
                    ?>
