...
/**
 * FLUSH REWRITE RULES (executar apenas uma vez)
 */
function camisa10_flush_rewrite_rules() {
    camisa10_register_curso_post_type();
    camisa10_register_curso_taxonomies();
    flush_rewrite_rules();
}
// Descomente a linha abaixo, salve, recarregue o site, depois comente novamente
// add_action('init', 'camisa10_flush_rewrite_rules');
