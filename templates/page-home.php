            ...
            <div class="col-6 col-md-3">
                <div class="stat-card animate-on-scroll">
                    ...
                    <div class="stat-number">
                        <span data-count="4.9">0</span><span class="stat-decimal">.9</span>
                    </div>
        ...
        <div class="testimonials-slider">
            ...
            <div class="testimonial-card">
                ...
                <div class="testimonial-author">
                    <div class="author-avatar">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/avatar-placeholder.jpg" 
                             alt="Aluno" class="rounded-circle">
                    </div>
                    <div class="author-info">
    ...
    <div class="container">
                        ...
                        <?php else : ?>
                            <a href="<?php the_permalink(); ?>">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/instructor-placeholder.jpg" 
                                     alt="<?php the_title(); ?>" class="img-fluid rounded-circle">
                            </a>
                        <?php endif; ?>
                    </div>
        ...
        <div class="text-center mt-5">
            <a href="<?php echo esc_url(get_post_type_archive_link('especialista')); ?>" class="btn btn-outline-primary btn-lg">
                Ver Todos Especialistas <i class="fas fa-arrow-right ms-2"></i>
            </a>
        </div>
    </div>
</section>
...
<!-- ========================================
     CTA SECTION
     Layout: Centralizado
     Componentes: Headline + Subheadline + 2 Botões
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 text-center">
                ...
                <div class="cta-buttons animate-on-scroll">
                    <a href="<?php echo esc_url(get_theme_mod('camisa10_cta_button1_url', '#')); ?>" 
                       class="btn btn-dark btn-lg me-3">
                        <?php echo get_theme_mod('camisa10_cta_button1_text', 'Começar Gratuitamente'); ?>
                    </a>
                    <a href="<?php echo esc_url(get_theme_mod('camisa10_cta_button2_url', '#mentorias')); ?>" 
    ...
    <div class="container">
        ...
        <div class="text-center mt-5">
            <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" class="btn btn-outline-primary btn-lg">
                Ver Todos os Artigos <i class="fas fa-arrow-right ms-2"></i>
            </a>
        </div>
    </div>
</section>
...
<!-- ========================================
     ...
     Componentes: Accordions interativos
     Total: 10 itens
     ======================================== -->
    ...
    <div class="container">
                ...
                <div class="accordion" id="faqAccordionLeft">
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse1" class="accordion-collapse collapse show" 
                            ...
                            <div class="accordion-body">
                                ...
                                Você precisará criar uma conta ou fazer login caso já tenha uma. Após o pagamento, 
                                você terá acesso imediato ao conteúdo do curso.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse2" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Sim! Todos os nossos cursos oferecem certificado de conclusão reconhecido no mercado. 
                                Você receberá o certificado automaticamente após concluir todas as aulas e atividades do curso, 
                                com nota mínima de aprovação de 70%.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse3" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                A duração varia de acordo com o curso. Temos cursos rápidos de 2-5 horas, 
                                cursos médios de 10-20 horas e cursos completos com mais de 30 horas de conteúdo. 
                                Todas as informações estão disponíveis na página de cada curso.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse4" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Sim! Nossa plataforma é 100% flexível. Você pode assistir às aulas quando e onde quiser, 
                                quantas vezes precisar. Não há prazos rígidos - você aprende no seu próprio ritmo, 
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse5" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Sim! Oferecemos garantia de 7 dias. Se você não estiver satisfeito com o curso 
                                por qualquer motivo, basta solicitar o reembolso total dentro deste período. 
                ...
                <div class="accordion" id="faqAccordionRight">
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse6" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Nossas mentorias são sessões individuais com especialistas. Você agenda um horário, 
                                prepara suas dúvidas e objetivos, e participa de uma videoconferência exclusiva. 
                                O mentor vai guiar você com feedback personalizado e plano de ação específico para suas necessidades.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse7" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                ...
                                Quando você se inscreve em um curso, tem acesso vitalício a todas as atualizações futuras, 
                                sem custo adicional.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse8" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Sim! Nossa plataforma é 100% responsiva e funciona perfeitamente em celulares, 
                                tablets e computadores. Você pode começar uma aula no computador e continuar 
                                no celular sem perder o progresso.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse9" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Depende do curso! Cada curso indica claramente o nível de conhecimento necessário 
                                (iniciante, intermediário ou avançado). Temos cursos para todos os níveis, 
                                desde quem está começando do zero até profissionais experientes que querem se especializar.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item animate-on-scroll">
                        ...
                        <div id="faqCollapse10" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
                                Você pode entrar em contato através do email suporte@camisa10.com.br, 
                                pelo chat ao vivo disponível no canto inferior direito da tela, 
                                ou pelo WhatsApp (21) 99999-9999. Nossa equipe responde em até 24 horas úteis.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center mt-5">
            ...
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('contato'))); ?>" class="btn btn-primary btn-lg">
                Entre em Contato <i class="fas fa-envelope ms-2"></i>
            </a>
        </div>
    </div>
</section>
